...
class PopmaszynaGUI(Frame,object):
    ...
    def akcja_main_window(self):
        ...
        main_window.title("Popmaszyna")
          przycisk1 = Button(main_window, text = "1 DZIWIĘK", fg = "dark green",  command = lambda: self.play_sample(0))
        przycisk1.grid(row = 1, column = 1)
        przycisk2 = Button(main_window, text = "2 DZIWIĘK", fg = "navy", command = lambda: self.play_sample(1))
        przycisk2.grid(row = 2, column = 1)
        przycisk3 = Button(main_window, text = "3 DZIWIĘK", fg = "dodger blue", command = lambda: self.play_sample(2))
        przycisk3.grid(row = 3, column = 1)
        przycisk4 = Button(main_window, text = "4 DZIWIĘK", fg = "yellow", command = lambda: self.play_sample(3))
        przycisk4.grid(row = 4, column = 1)
        przycisk5 = Button(main_window, text = "5 DZIWIĘK", fg = "goldenrod", command = lambda: self.play_sample(4))
        przycisk5.grid(row =1 , column = 2)
        przycisk6 = Button(main_window, text = "6 DZIWIĘK", fg = "red", command = lambda: self.play_sample(5))
        przycisk6.grid(row = 2, column = 2)
        przycisk7 = Button(main_window, text = "7 DZIWIĘK", fg = "deep pink", command = lambda: self.play_sample(6))
        przycisk7.grid(row = 3, column = 2)
        przycisk8 = Button(main_window, text = "8 DZIWIĘK", fg = "cyan2", command = lambda: self.play_sample(7))
        przycisk8.grid(row = 4, column = 2)
        przycisk9 = Button(main_window, text = "9 DZIWIĘK", fg = "OliveDrab4", command = lambda: self.play_sample(8))
        przycisk9.grid(row = 1, column = 3)
        przycisk10 = Button(main_window, text = "10 DZIWIĘK", fg = "sienna2", command = lambda: self.play_sample(9))
        przycisk10.grid(row = 2, column = 3)
        przycisk11 = Button(main_window, text = "11 DZIWIĘK", fg = "tan4", command = lambda: self.play_sample(10))
        przycisk11.grid(row = 3, column = 3)
        przycisk12 = Button(main_window, text = "12 DZIWIĘK", fg = "brown4", command = lambda: self.play_sample(11))
        przycisk12.grid(row = 4, column = 3)
        przycisk13 = Button(main_window, text = "13 DZIWIĘK", fg = "coral2", command = lambda: self.play_sample(12))
        przycisk13.grid(row = 1, column = 4)
        przycisk14 = Button(main_window, text = "14 DZIWIĘK", fg = "magenta2", command = lambda: self.play_sample(13))
