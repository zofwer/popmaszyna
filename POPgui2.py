...
class PopmaszynaGUI(Frame,object):
    ...
    def akcja_main_window(self):
        ...
        przycisk15 = Button(main_window, text = "electric bass", fg = "magenta2",bg="navy" , width=30, height=5, command = lambda: self.play_sample(14))
        przycisk15.grid(row = 3, column = 4)
        przycisk16 = Button(main_window, text = "cuica", fg = "dark green",bg="tan4" , width=30, height=5, command = lambda: self.play_sample(15))
...
sample14 = "szczek.wav"
sample15 = "electricbass.wav"
sample16 = "Cuica-2.wav"
