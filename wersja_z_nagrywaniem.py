...
okno_nagrywania = Tk()
okno_nagrywania.geometry("200x200")
okno_nagrywania.title("Nagrywanie")
...
def nagrywanie():
    ...
    time = 10
    print("recording...")
    nagranie = sd.rec(int(time * fs), samplerate = fs, channels = 1)
    sd.wait()
    return nagranie #print("blebleble.wav",fs, nagranie)
...
przycisk_do_nagrywania = Button(okno_nagrywania, text = "Kliknij by zacząć nagrywanie", fg = "purple", command = nagrywanie)
przycisk_do_nagrywania.pack()
